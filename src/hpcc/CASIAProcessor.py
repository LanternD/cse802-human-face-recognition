...
ROOT_PATH = '/mnt/home/sunmeng2/CSE802FP/'
FILE_PATH = '/mnt/research/CSE_802_SPR_17/casia_mtcnn_cropped/' # 'F:/cse802_data/casia_mtcnn_cropped/' 
LFW_PATH = '/mnt/research/CSE_802_SPR_17/lfw_mtcnn_cropped2/'
...
class CNNModel(object):
    ...
    def network(self):
        ...
        if model_h5_file.is_file():
            ...
            my_opt = Adadelta(lr=2.0, decay=0.0002)
            self.model.compile(loss='categorical_crossentropy', optimizer=my_opt, metrics=['accuracy'])
    ...
    def flow_from_dir_fitting(self, progress):
        ...
        self.model.fit_generator(
            ...
            verbose=2,
            epochs=10, callbacks=[csv_logger])
...
class LFWProcessor(object):
    ...
    def csv_generator(self):
        ...
        with open('./lfw_feature_matrix.csv', 'w', newline='') as csvfile:
            ...
            model = load_model('./v2_model_weights_best.h5')
