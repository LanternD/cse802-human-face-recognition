...
outMatFile = [outDir, strcat('result_lfw_pca_', file_name, '.mat')]; % output mat file
outLogFile = [outDir, strcat('result_lfw_pca_', file_name, '.txt')]; % output text file
