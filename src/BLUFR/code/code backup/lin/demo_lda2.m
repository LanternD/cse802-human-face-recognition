...
Dir = '../';
flag = 'CNN';
gpu2 = '/mnt/research/linkaixi/AllData/cse802/lfw_mtcnn_cropped2_all/';
feaFile = strcat(gpu2,'CNNfeat_pool5_04232351.mat'); % Mat file storing extracted features
configFile = strcat(Dir, 'config/lfw/blufr_lfw_config.mat'); % configuration file for this evaluation
outDir =  strcat(Dir, 'result/'); % output directory
outMatFile = [outDir, 'result_lfw_cnnlda.mat']; % output mat file
outLogFile = [outDir, 'result_lfw_cnnlda.txt']; % output text file
